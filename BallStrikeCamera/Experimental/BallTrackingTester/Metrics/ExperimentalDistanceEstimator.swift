...
struct ExperimentalDistanceEstimator {
    func estimate(
        ...
        // Physics-based ideal carry: v²·sin(2θ)/g (no drag, no lift)
        ...
        // Speed multiplier on rollout fraction
